    ...
    <div className="mt-[58px] mx-[22px] lg:mt-[85px] lg:mx-[122px] lg:gap-[69px] lg:flex lg:flex-row lg:items-center lg:justify-center">
      ...
      <div>
        ...
        <form
          ...
          className="w-fit mx-auto flex flex-col mt-[50px] items-center justify-center gap-[21px] rounded-[18px] border-[1px] border-[#232328] bg-[#0D0D11] px-[13px] pt-[20px] pb-[13px]"
        >
          <header>

...
export default function Footer() {
  return (
    <footer className="flex flex-row justify-center items-center w-full mb-[21px] mt-[51px] md:mb-[35px] md:mt-[78px]">
      <h3 className="group text-main-100 rounded-[100px] px-[18px] py-[3px] transition-all duration-300 leading-normal font-clash text-[15px] md:py-[8.5px] md:px-[18.5px] border border-[#232328]">
